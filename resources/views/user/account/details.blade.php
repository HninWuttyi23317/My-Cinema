    ...
    <div class="main-content">
        ...
        <div class="section__content section__content--p30">
            <div class="container-fluid ">
                ...
                <div class="offset-1 col-5 offset-3 py-5">
                    <div class="card shadow-lg">

                        <div class="card-header bg-danger py-2 shadow-sm">
                        ...
                        <div class="card-body bg-danger-subtle ">
                            ...
                            <div class="row">
                                ...
                                <div class="col-6 offset-3">
                                    ...
                                    <h5 class="my-3 text-dark">
                                        <i class="fa-solid fa-location-dot me-2"></i>{{ Auth::user()->address }}
                                    </h5>
                                    <h5 class="my-3 text-dark">
                                        <i  class="fa-solid fa-calendar-days me-2"></i>{{ Auth::user()->created_at->format('j-F-Y') }}
                                    </h5>
                                </div>
                            </div>
                            <div class="card-footer">

                                <a href="{{ route('user#changeProfile') }}" class=" col-12">
